...
public:
  ...
  : Node("listener")
  {
    ...
    auto callback =
      [this](const homework_msgs::msg::HelloMsg::SharedPtr msg) -> void
      {
    ...
    sub_ = create_subscription<homework_msgs::msg::HelloMsg>(topic_name, 10, callback);
  }

private:
  rclcpp::Subscription<homework_msgs::msg::HelloMsg>::SharedPtr sub_;
};
